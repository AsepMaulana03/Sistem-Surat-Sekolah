        ...
        <div>
            ...
            <nav class="mt-4 px-3 space-y-1">
                ...
                <a href="{{ route('incoming-letters.index') }}"
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg {{ request()->routeIs('incoming-letters.*') ? 'bg-white/10 text-white' : 'text-gray-400 hover:bg-white/5 hover:text-white' }} text-sm font-medium transition-all duration-150">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
