...
<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Surat yang telah disetujui atau ditolak</p>
        </div>
        <!-- Summary Badge -->
        <div class="flex items-center gap-2">
            <span class="inline-flex items-center gap-1.5 px-3 py-2 bg-green-50 text-green-600 text-xs font-semibold rounded-lg border border-green-100">
                ...
                {{ \App\Models\Letter::where('status','approved')->count() }} Disetujui
            </span>
            <span class="inline-flex items-center gap-1.5 px-3 py-2 bg-red-50 text-red-500 text-xs font-semibold rounded-lg border border-red-100">
                ...
                {{ \App\Models\Letter::where('status','rejected')->count() }} Ditolak
            </span>
        </div>
    </div>

    <!-- Filter & Search -->
    <form method="GET" action="{{ route('kepsek.arsip') }}" class="mb-6">
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="bg-gray-50 border-b border-gray-100">
                    ...
                    <th class="px-5 py-4 text-left text-xs font-semibold text-gray-500 uppercase">Tgl. Review</th>
                    <th class="px-5 py-4 text-left text-xs font-semibold text-gray-500 uppercase">Status</th>
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-5 py-4 text-gray-600">
                        {{ $letter->reviewed_at ? $letter->reviewed_at->isoFormat('D MMM Y') : '-' }}
                    </td>
                    <td class="px-5 py-4">
                ...
                <tr>
                    <td colspan="8" class="px-5 py-16 text-center">
                        <div class="flex flex-col items-center gap-3">
                            ...
                            <p class="text-gray-300 text-xs">Surat yang telah disetujui atau ditolak akan muncul di sini</p>
                        </div>
                    </td>
                </tr>
                @endforelse
